...
public class Sample
{
    public static void main(String [] args) {
        try{
            ...
            // 使用环境变量或配置文件中的密钥
            String secretId = System.getenv("TENCENT_CLOUD_SECRET_ID");
            String secretKey = System.getenv("TENCENT_CLOUD_SECRET_KEY");
            if (secretId == null || secretKey == null) {
                secretId = "PLACEHOLDER_SECRET_ID"; // 请替换为您的 SecretId
                secretKey = "PLACEHOLDER_SECRET_KEY"; // 请替换为您的 SecretKey
            }
